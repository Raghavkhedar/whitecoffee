...
check('rest day, in 09:00 out 09:30 → 30 pending, 0 shortage',
  computeDayLedger({ shiftStartMin: 0, shiftEndMin: 0, inMin: START - 60, outMin: START - 30, declaredOtMins: 0, isRestDay: true, isWoDay: false }),
...
check('rest day, 10:00–15:00, declared 30 → still +300 pending (ceiling ignored)',
  computeDayLedger({ shiftStartMin: 0, shiftEndMin: 0, inMin: START, outMin: 15 * 60, declaredOtMins: 30, isRestDay: true, isWoDay: false }),
...
check('rest day ignores shift (10:00–20:00)',
  computeDayLedger({ shiftStartMin: START, shiftEndMin: END, inMin: START, outMin: 20 * 60, declaredOtMins: 0, isRestDay: true, isWoDay: false }),
  { pendingExtraMins: 600, shortageMins: 0 });

console.log('\nNo shift, not a rest day:');
check('no shift → nothing accrues',
  computeDayLedger({ shiftStartMin: 0, shiftEndMin: 0, inMin: START, outMin: END, declaredOtMins: 0, isRestDay: false, isWoDay: false }),
  { shortageMins: 0, autoOtMins: 0, pendingExtraMins: 0 });
